  ...
  en: {
    translation: {
      ...
      guessForm: {
        ...
        portion: "Portion",
        bonus: "Missing word",
        bonusLengthHint: "Enter {{count}} characters.",
        bonusCharacterFeedback: "{{correct}} characters are correct and {{present}} are in the wrong position.",
        bonusCorrect: "All characters are correct.",
  ...
  he: {
    translation: {
      ...
      guessForm: {
        ...
        portion: "פרשה",
        bonus: "מילה חסרה",
        bonusLengthHint: "הקלידו {{count}} תווים.",
        bonusCharacterFeedback: "{{correct}} תווים במקום הנכון ו־{{present}} במקום אחר.",
        bonusCorrect: "כל התווים במקום הנכון.",
        bonusHint: "רמז",
